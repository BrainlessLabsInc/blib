#ifndef __BLIB_GLFW_PLATFORM_WIN32_INCLUDED__
...
#define WGL_CONTEXT_COMPATIBILITY_PROFILE_BIT_ARB 0x00000002
   ...
   typedef int  ( * CHOOSEPIXELFORMAT_T) (HDC,CONST PIXELFORMATDESCRIPTOR*);
   typedef int  ( * DESCRIBEPIXELFORMAT_T) (HDC,int,UINT,LPPIXELFORMATDESCRIPTOR);
   typedef int  ( * GETPIXELFORMAT_T) (HDC);
   typedef BOOL ( * SETPIXELFORMAT_T) (HDC,int,const PIXELFORMATDESCRIPTOR*);
   typedef BOOL ( * SWAPBUFFERS_T) (HDC);
#endif // _GLFW_NO_DLOAD_GDI32

   // winmm.dll function pointer typedefs
#ifndef _GLFW_NO_DLOAD_WINMM
   typedef MMRESULT ( * JOYGETDEVCAPSA_T) (UINT,LPJOYCAPSA,UINT);
   typedef MMRESULT ( * JOYGETPOS_T) (UINT,LPJOYINFO);
   typedef MMRESULT ( * JOYGETPOSEX_T) (UINT,LPJOYINFOEX);
...
#endif // __BLIB_GLFW_PLATFORM_WIN32_INCLUDED__